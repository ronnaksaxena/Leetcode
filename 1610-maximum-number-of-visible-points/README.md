<h2><a href="https://leetcode.com/problems/maximum-number-of-visible-points">1610. Maximum Number of Visible Points</a></h2><h3>Hard</h3><hr><p>You are given an array <code>points</code>, an integer <code>angle</code>, and your <code>location</code>, where <code>location = [pos<sub>x</sub>, pos<sub>y</sub>]</code> and <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> both denote <strong>integral coordinates</strong> on the X-Y plane.</p>
